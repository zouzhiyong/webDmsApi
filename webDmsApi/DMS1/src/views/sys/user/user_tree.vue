<template>
  <el-tree ref="tree" :data="treeData" :props="defaultProps" node-key="DeptID" :current-node-key="0" :highlight-current="true" :default-expanded-keys="[0]" @node-click="handleNodeClick"></el-tree>
</template>
